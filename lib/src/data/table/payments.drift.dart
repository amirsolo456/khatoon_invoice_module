          ...
          .createAlias(
            i0.$_aliasNameGenerator(
              i5.ReadDatabaseContainer(
                db,
              ).resultSet<i2.$PaymentsTable>('payments').invoiceId,
              i5.ReadDatabaseContainer(
                db,
              ).resultSet<i4.$InvoicesTable>('invoices').id,
            ),
          );
                    ...
                    if (invoiceId) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: i2.$$PaymentsTableReferences
                                    ._invoiceIdTable(db),
                                referencedColumn: i2.$$PaymentsTableReferences
                                    ._invoiceIdTable(db)
                                    .id,
                              )
                              as T;
...
class $PaymentsTable extends i3.Payments
  ...
  static const i0.VerificationMeta _invoiceIdMeta = const i0.VerificationMeta(
    'invoiceId',
  );
  @override
  ...
  static const i0.VerificationMeta _amountMeta = const i0.VerificationMeta(
    'amount',
  );
  @override
  ...
  static const i0.VerificationMeta _directionMeta = const i0.VerificationMeta(
    'direction',
  );
  @override
  ...
  static const i0.VerificationMeta _fromPartyIdMeta = const i0.VerificationMeta(
    'fromPartyId',
  );
  @override
  ...
  static const i0.VerificationMeta _toPartyIdMeta = const i0.VerificationMeta(
    'toPartyId',
  );
  @override
  ...
  static const i0.VerificationMeta _referenceMeta = const i0.VerificationMeta(
    'reference',
  );
  @override
  ...
  static const i0.VerificationMeta _notesMeta = const i0.VerificationMeta(
    'notes',
  );
  @override
